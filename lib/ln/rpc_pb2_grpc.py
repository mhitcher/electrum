...
class ElectrumBridgeStub(object):
  ...
  def __init__(self, channel):
    ...
    self.WriteDb = channel.unary_unary(
        ...
        request_serializer=rpc__pb2.WriteDbRequest.SerializeToString,
        response_deserializer=rpc__pb2.WriteDbResponse.FromString,
        )
    ...
    self.DeriveKey = channel.unary_unary(
        ...
        request_serializer=rpc__pb2.DeriveKeyRequest.SerializeToString,
        response_deserializer=rpc__pb2.DeriveKeyResponse.FromString,
        )
    self.DeriveNextKey = channel.unary_unary(
        '/electrumbridge.ElectrumBridge/DeriveNextKey',
        request_serializer=rpc__pb2.DeriveNextKeyRequest.SerializeToString,
        response_deserializer=rpc__pb2.DeriveNextKeyResponse.FromString,
        )
    self.DerivePrivKey = channel.unary_unary(
        '/electrumbridge.ElectrumBridge/DerivePrivKey',
        request_serializer=rpc__pb2.DerivePrivKeyRequest.SerializeToString,
        response_deserializer=rpc__pb2.DerivePrivKeyResponse.FromString,
        )
    self.ScalarMult = channel.unary_unary(
        '/electrumbridge.ElectrumBridge/ScalarMult',
        request_serializer=rpc__pb2.ScalarMultRequest.SerializeToString,
        response_deserializer=rpc__pb2.ScalarMultResponse.FromString,
        )
...
def add_ElectrumBridgeServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'WriteDb': grpc.unary_unary_rpc_method_handler(
          servicer.WriteDb,
          request_deserializer=rpc__pb2.WriteDbRequest.FromString,
          response_serializer=rpc__pb2.WriteDbResponse.SerializeToString,
      ),
      ...
      'DeriveKey': grpc.unary_unary_rpc_method_handler(
          servicer.DeriveKey,
          request_deserializer=rpc__pb2.DeriveKeyRequest.FromString,
          response_serializer=rpc__pb2.DeriveKeyResponse.SerializeToString,
      ),
      'DeriveNextKey': grpc.unary_unary_rpc_method_handler(
          servicer.DeriveNextKey,
          request_deserializer=rpc__pb2.DeriveNextKeyRequest.FromString,
          response_serializer=rpc__pb2.DeriveNextKeyResponse.SerializeToString,
      ),
      'DerivePrivKey': grpc.unary_unary_rpc_method_handler(
          servicer.DerivePrivKey,
          request_deserializer=rpc__pb2.DerivePrivKeyRequest.FromString,
          response_serializer=rpc__pb2.DerivePrivKeyResponse.SerializeToString,
      ),
      'ScalarMult': grpc.unary_unary_rpc_method_handler(
          servicer.ScalarMult,
          request_deserializer=rpc__pb2.ScalarMultRequest.FromString,
          response_serializer=rpc__pb2.ScalarMultResponse.SerializeToString,
      ),
  }
